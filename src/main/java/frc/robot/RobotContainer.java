...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        autoChooser.setDefaultOption("Speaker, Drive Out", new Speaker(s_Swerve, s_launcher, s_intake, s_arm));
        autoChooser.addOption("Shoot-Reload-Shoot", new LaunchReload(s_Swerve, s_launcher, s_intake, s_arm));
